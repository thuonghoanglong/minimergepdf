...
select_button = tk.Button(root, text="Select PDFs", command=select_files, padx=10, pady=5, bg="#D5E8D4")
sort_button = tk.Button(root, text="Sort", command=sort_files, padx=10, pady=5, bg="#F8E0D4")
export_button = tk.Button(root, text="Merge PDFs", command=export_files, padx=10, pady=5, bg="#D4E8F8")
listbox = tk.Listbox(root, selectmode=tk.SINGLE, width=50, height=10, bd=0, highlightthickness=0, relief="flat", bg="#F0F0F0")
count_label = tk.Label(root, text="Selected PDFs: 0", bg="#F0F0F0")
